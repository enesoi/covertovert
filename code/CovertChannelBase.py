...
from scapy.all import ARP, LLC, send, sendp
...
class CovertChannelBase:
    ...
    def convert_string_message_to_binary(self, message):
        ...
        """
        binary_message_to_transfer = "".join(
    ...
    def generate_random_message(self, min_length=5, max_length=10):
        ...
        ), "min_length must be smaller than or equal to the max_length"
    ...
    def generate_random_binary_message(self, min_length=50, max_length=100):
        ...
        random_binary_message = self.convert_string_message_to_binary(
            message=random_message
        )
        return random_binary_message

    def generate_random_binary_message_with_logging(
        self, log_file_name, min_length=50, max_length=100
    ):
        """
